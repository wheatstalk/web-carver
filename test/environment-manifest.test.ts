      ...
      Value: {
        'Fn::Sub': [
          '{\n  "version": "1.0.0",\n  "crossStackDependencyExportName": "Manifest",\n  "vpcId": "${Ref0}",\n  "namespaceAttributes": {\n    "namespaceType": "DNS_PRIVATE",\n    "namespaceArn": "${Ref1}",\n    "namespaceId": "${Ref2}",\n    "namespaceName": "${Ref3}"\n  },\n  "meshArn": "${Ref4}",\n  "clusterAttributes": {\n    "clusterName": "${Ref5}",\n    "clusterArn": "${Ref6}",\n    "hasEc2Capacity": false,\n    "securityGroupIds": []\n  },\n  "defaultGatewayAttributes": {\n    "securityGroupIds": [\n      "${Ref7}"\n    ],\n    "virtualGatewayArn": "${Ref8}"\n  },\n  "defaultRouterAttributes": {\n    "securityGroupIds": [\n      "${Ref9}"\n    ],\n    "virtualRouterArn": "${Ref10}",\n    "virtualServiceArn": "${Ref11}"\n  }\n}',
          {
            ...
            Ref1: { 'Fn::GetAtt': ['Namespace9B63B8C8', 'Arn'] },
            Ref2: { 'Fn::GetAtt': ['Namespace9B63B8C8', 'Id'] },
            Ref3: 'default',
            Ref4: { Ref: 'EnvironmentMeshE4273EA5' },
            Ref5: { Ref: 'EnvironmentClusterE81C7902' },
            Ref6: { 'Fn::GetAtt': ['EnvironmentClusterE81C7902', 'Arn'] },
            Ref7: { 'Fn::GetAtt': ['EnvironmentGatewayFargateGatewayServiceSecurityGroupDFC77C29', 'GroupId'] },
            Ref8: { Ref: 'EnvironmentGateway3306D38F' },
            Ref9: { 'Fn::GetAtt': ['EnvironmentGatewayFargateGatewayServiceSecurityGroupDFC77C29', 'GroupId'] },
            Ref10: { Ref: 'EnvironmentRouter36ACE08F' },
            Ref11: { Ref: 'EnvironmentRouterService4B5D623E' },
          },
        ],
      },
    }));
