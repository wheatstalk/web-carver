...
import { ApplicationLoadBalancedWebCarverGateway } from '../src';

describe('WebCarver Gateway', () => {
  describe('ApplicationLoadBalancerWebCarverGateway', () => {
    test('without certificate, it creates a load balancer with http listener and no https', () => {
      ...
      // WHEN
      new ApplicationLoadBalancedWebCarverGateway(stack, 'Gateway', {
        cluster,
        certificates: [],
        mesh,
